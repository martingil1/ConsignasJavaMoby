...
public class Exercise4 {
    ...
    public static void main(String[] args) {
        ...
        Order order1 = new Order(1L,product4,customer3, LocalDateTime.now(),false);
        controllerOrder.addOrder(order1);

        Order order2 = new Order(2L,product1,customer1, LocalDateTime.now(),false);
        controllerOrder.addOrder(order2);

        Order order3 = new Order(3L,product5,customer4, LocalDateTime.now(),false);
        controllerOrder.addOrder(order3);

        Order order4 = new Order(4L,product4,customer1, LocalDateTime.now(),false);
        controllerOrder.addOrder(order4);

        Order order5 = new Order(5L,product6,customer3, LocalDateTime.now(),false);
        controllerOrder.addOrder(order5);

        Order order6 = new Order(6L,product10,customer4, LocalDateTime.now(),false);
        controllerOrder.addOrder(order6);

        Order order7 = new Order(7L,product7,customer2, LocalDateTime.now(),false);
        ...
        System.out.println("----------------------------------");
        System.out.println(controllerOrder.showOrders());
